...
namespace gifbot.tests
{
	public class ParserTests
	{
		...
		[InlineData("translate that's what I'm talking about!?!", Function.Translate,
			new[] {"that's", "what", "I'm", "talking", "about!?!"}, 1, Size.FixedHeight)]
		...
		[InlineData("delete", Function.Delete, new string[] {}, 1, Size.FixedHeight)]
		[InlineData("delete foo", Function.Delete, new[] {"foo"}, 1, Size.FixedHeight)]
		[InlineData("delete 5", Function.Delete, new string[] { }, 5, Size.FixedHeight)]
		[InlineData("delete 500", Function.Delete, new string[] { }, 500, Size.FixedHeight)]
		[InlineData("delete -5", Function.Delete, new string[] { }, 1, Size.FixedHeight)]
